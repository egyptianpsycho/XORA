...
const Footer = () => {
  return (
    <footer>
      <div className="contatiner py-10">
        <div className="flex w-full  max-md:flex-col">
          <div className="small-compact flex flex-1 flex-wrap items-center justify-center gap-5">
            <p className="opacity-70"><span className="text-[18px] relative top-0.5">&copy;</span>
            Copyright, Ziad Abbas 2025</p>
          </div>
          ...
          <ul className="flex flex-1  justify-center gap-3 max-md:mt-10 md:justify-end lg:gap-4 last:mr-2">
